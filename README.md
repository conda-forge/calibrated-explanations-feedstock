About calibrated-explanations-feedstock
=======================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/calibrated-explanations-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/calibrated-explanations-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add calibrated-explanations
# for installing globally
pixi global install calibrated-explanations
```
...
It is possible to list all of the versions of `calibrated-explanations` available on your platform:
...
```
pixi search calibrated-explanations --channel conda-forge
```
